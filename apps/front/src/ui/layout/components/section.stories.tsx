...
export const AsText: StoryObj<typeof LayoutComponents.Root> = {
  args: {
    title:
      'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quae doloremque obcaecati adipisci dolorem optio, itaque labore, dolore laboriosam facilis quam veniam, repudiandae perspiciatis temporibus rerum ex culpa laudantium nemo enim!',
    title_as: 'h1',
    children: (
      <>
        <Mock.PanelText />
