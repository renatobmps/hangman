...
export const PanelText = () => (
  <p style={{ font: 'normal 1rem' }}>
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus itaque alias
    quia maxime iure? Assumenda provident ipsam corrupti tempora numquam
    expedita odio! Doloremque numquam aspernatur, eius ad sapiente et suscipit!
  </p>
);
