...
export const getServerSideProps = async (
  ...
  if (!ctx.params) {
    throw new Error('getServerSideProps without params');
  }
...
const Page = ({ user_id }: Ssr) => {
  const [isUserActivated, setIsUserActivated] = useState<boolean>(
    !!(user_id % 3),
  );
      ...
      <LayoutComponents.Panel>
        <S.UserSection>
          ...
          <InputComponents.Checkbox
            checked={isUserActivated}
            onClick={handleUserActivated}
          />
        </S.UserSection>
        ...
        <LayoutComponents.Section title="Log" title_as="h2">
          <S.LogPanel>
            ...
            >
              ...
              <S.LogDate dateTime="2023-11-29T14:45">
                29/11/2023 14:45
              </S.LogDate>
            </S.LogLine>
            <S.LogLine>
